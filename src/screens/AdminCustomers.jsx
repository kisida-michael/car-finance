...
const AdminCustomers = () => {
  ...
  useEffect(() => {
    ...
    // Call the handleResize function to set the initial value of isSmallScreen
    handleResize();
  ...
  const debouncedSearch = useCallback(
    debounce((search) => {
      if (isDataFetched) { // Only run search if data has been fetched        console.log('Searching...', search)
