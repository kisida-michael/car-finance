...
import CustomAlert from "../../AdminCustomAlert";

import { FileUpload } from "./AdminFormComponents";
  ...
  return (
    <form className="p-4 space-y-4">
      ...
      {fields.map((field, index) => (
        <div key={field}>
          <h3 className="text-xl text-gray-200 mb-4 font-semibold">{placeholders[index]}</h3>
            ...
            <div className="flex flex-wrap items-center space-x-2 mb-4 min-w-full max-w-full">
              ...
              {selectedFiles[field] && (
                <button
                  ...
                  className=" bg-admin hover:bg-red-600 hover:text-white text-gray-300 py-1 px-2 rounded text-sm"
                >
                  Clear
                </button>
              )}
